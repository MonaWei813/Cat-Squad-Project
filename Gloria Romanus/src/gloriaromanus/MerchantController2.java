...
public class MerchantController2 {
    @FXML
    ...
    public void handlecancel() {
        InvasionMenuController2.ColseMerchantSatge();
    }

    @FXML
    public void handleConfirm(ActionEvent e) throws IOException {
        if (listprovinces.getValue() == null || numbersoldier.getValue() == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("WarningaddSoldiers2.fxml"));
            stage = new Stage();
            Parent root;
            root = loader.load();
            ...
            Player player = goal1Controller.s1.Player2();
